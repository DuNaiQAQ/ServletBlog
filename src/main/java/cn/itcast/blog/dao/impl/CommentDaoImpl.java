...
public class CommentDaoImpl implements CommentDao {
    ...
    public void saveComment(Comment comment) {
        String sql="intsert into comment(id,post_id,uname_email,content,ctime,parent,parent_name,count_good) values(?,?,?,?,?,?,?,?)";
        template.update(sql,comment.getId(),comment.getPost_id(),comment.getUname_email(),comment.getContent(),comment.getCtime(),
