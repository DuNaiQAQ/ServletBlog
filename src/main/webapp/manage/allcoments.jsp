...
<%
    ...
    comments=service.loadAllComment();
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="./allcoments.jsp" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>查看所有评论</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">已发布的评论</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">所有已发布的评论</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            <table id="articles" class="table table-bordered table-hover dataTable dtr-inline"
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="articles" rowspan="1"
                                        colspan="1" aria-sort="ascending"
                                        aria-label="评论者邮箱: activate to sort column descending">评论者邮箱
                                    </th>
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="articles" rowspan="1"
                                        colspan="1" aria-sort="ascending"
