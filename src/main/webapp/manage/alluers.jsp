...
//在加载页面是需要进行的代码操作
    ...
    pageContext.setAttribute("allusers",allusers);
%>
<html lang="en">
<head>
    <meta charset="utf-8">
                            ...
                            <table id="articles" class="table table-bordered table-hover dataTable dtr-inline"
                                ...
                                <tr role="row">
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="articles" rowspan="1"
                                        ...
                                        aria-label="文章ID: activate to sort column descending">用户ID
                                    </th>
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="articles" rowspan="1"
                                        colspan="1" aria-sort="ascending"
                                        aria-label="文章ID: activate to sort column descending">用户名称
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="articles" rowspan="1" colspan="1"
                                        aria-label="文章作者: activate to sort column ascending">用户头像
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="articles" rowspan="1" colspan="1"
                                        aria-label="文章标题: activate to sort column ascending">用户邮箱
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="articles" rowspan="1" colspan="1"
                                        aria-label="发布时间: activate to sort column ascending">用户个人简介
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="articles" rowspan="1" colspan="1"
                                        aria-label="最后修改时间: activate to sort column ascending">用户生日
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="articles" rowspan="1" colspan="1"
                                        aria-label="点赞次数: activate to sort column ascending">用户权限
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="articles" rowspan="1" colspan="1"
                                ...
                                <c:forEach var="a" items="${allusers}">
                                    <tr>
                                        ...
                                        <td>${a.getRole()}</td>
                                        <td>
                                            <button type="button" class="btn btn-primary lookat">更改信息</button>
                                            <button type="button" class="btn btn-primary delete">删除用户</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
